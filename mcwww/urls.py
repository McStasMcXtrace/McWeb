...
urlpatterns = patterns(
    ...
    url(r'^job/(?P<group>\w+)/?$', 'mcsimulator.views.configure', name='configure'),
    url(r'^job/update/(?P<jobref>\w+)/(?P<group>\w+)/?$', 'mcsimulator.views.configurePOST', name='configurePOST'),
