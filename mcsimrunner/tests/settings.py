...
MCWEB_LDAP_DN = 'dc=localdomain'

LDAP_PW = 'verysecret'

# email / email list used for admin notifications
MCWEB_ADMIN_EMAIL = 'admin@localhost'
...
# mcweb site url
MCWEB_NOTIFY_EMAIL_URL = 'http://localhost'
# manage module url
MCWEB_ADMIN_EMAIL_URL = 'http://localhost/superlogin'
MCWEB_NOTIFY_ROOT_URL = 'https://localhost/'
# self-service password url
MCWEB_SSP_URL = 'http://localhost/ssp'

# used by uploader, NOTE: must not be empty (in which case the uploader will not work)
FILE_UPLOAD_PW = 'DONTUPLOAD'
...
SECRET_KEY = 'xne_dc*fb74a334571393902945dc0938cfd173wx7t4)e+b5k'
